    ...
    <>
      <div className="sm:h-screen sm:w-screen sm:overflow-hidden bg-[#0c1035]">
        ...
        <div className="flex xl:flex-row flex-col  items-center">
          <div className="bg-[url(/signInImage.127192f6.png)] xl:w-1/2 w-full xl:h-screen h-96 flex flex-col items-center justify-center text-2xl text-white tracking-widest backdrop-brightness-75 bg-center bg-cover">
          ...
          <div className="sm::w-1/2  flex flex-col justify-center text-left text-2xl sm:px-15 px-0 text-white mt-15 2xl:mt-0">
            <p className="text-3xl font-bold">Nice to meet you</p>
